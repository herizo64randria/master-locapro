...
//---------------------------------------------
    ...
    /**
     * @ORM\OneToMany(targetEntity="GestionBundle\Entity\PieceJointe", mappedBy="bonExpedition")
     */
    private $pjBonExpeditions; // Notez le « s »,
...
//------------------------------------------////////////////////
     ...
     * Add pjBonExpedition
     *
     * @param \GestionBundle\Entity\PieceJointe $pjBonExpedition
     *
     * @return BonExpedition
     */
    public function addPjBonExpedition(\GestionBundle\Entity\PieceJointe $pjBonExpedition)
    {
        $this->pjBonExpeditions[] = $pjBonExpedition;

        return $this;
    }

    /**
     * Remove pjBonExpedition
     *
     * @param \GestionBundle\Entity\PieceJointe $pjBonExpedition
     */
    public function removePjBonExpedition(\GestionBundle\Entity\PieceJointe $pjBonExpedition)
    {
        $this->pjBonExpeditions->removeElement($pjBonExpedition);
    }

    /**
     * Get pjBonExpeditions
     *
     * @return \Doctrine\Common\Collections\Collection
     */
